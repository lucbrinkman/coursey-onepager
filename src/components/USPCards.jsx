...
const usps = [
  {
    ...
    tooltip: 'We teach the things most likely to cause existential harm, not the politically convenient topics. Our learning outcomes include skills, not just knowledge.',
  },
  {
    icon: Brain,
    ...
    tooltip: 'We follow science-informed best practices and measure outcomes to ensure real learning—not just the feeling of having learned something.',
  },
  {
    icon: Rocket,
    ...
    tooltip: 'Humans only improve the platform—they don\'t run courses. We\'re designed to reach millions, not hundreds.',
  },
]
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-semibold text-lg text-gray-900 flex items-center">
                {usp.headline}
                <InfoTooltip content={usp.tooltip} />
              </h3>
            </div>
